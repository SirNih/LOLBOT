...
const { mimeTypes } = require('file-type')
    ...
    // {SETTING}  \\
    apikey = 'dapxzwabots' //GANTI PAKE APIKEY LU
    prefix = 'R' //GANTI PAKE PREFIX YANG LU MAU
    owner = '6282262572982' //GANTI PAKE NOMOR LU
    // {SETTING}  \\
